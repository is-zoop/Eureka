...
export const enLocale: LocalePlugin = {
  ...
  label: "English",
  messages: {
    "models.piCatalogTitle": "Enable Pi model catalog refresh",
    "models.piCatalogDescription": "Pi checks its official pi.dev catalog in the background. The official catalog adds and updates models; built-in retired models may remain visible.",
    "models.piCatalogRefresh": "Refresh from pi.dev",
    "models.piCatalogBusy": "Refreshing…",
    "models.piCatalogLast": "Last checked: {time}",
    "models.piCatalogOffline": "Offline mode is enabled, so pi.dev cannot be contacted.",
    "models.piCatalogError": "The catalog refresh did not complete. Pi kept its last valid catalog and will retry later.",
    "common.ok": "OK",
    "common.close": "Close",
    ...
    "settings.systemDescription": "Manage Eureka appearance and language preferences.",
    "settings.appearance": "Appearance",
    "settings.language": "Language",
    "settings.displayLanguage": "Display language",
    "settings.languageDescription": "Used for Eureka interface text.",
    "settings.theme.light": "Light",
    "settings.theme.dark": "Dark",
    "settings.theme.auto": "System",
    "usage.title": "Usage statistics",
    "usage.description": "Review local historical model usage across time, projects, and providers.",
    "usage.refresh": "Refresh",
    "usage.range": "Time range",
    "usage.range.7d": "7 days",
    "usage.range.30d": "30 days",
    "usage.range.90d": "90 days",
    "usage.range.12m": "12 months",
    "usage.range.all": "All history",
    "usage.totalTokens": "Total tokens",
    "usage.recordedCost": "Recorded cost",
    "usage.costCalls": "Calls with cost records",
    "usage.calls": "Calls",
    ...
    "usage.coverage": "Usage coverage: {usage} · cost coverage: {cost}",
    "usage.byTime": "By time",
    "usage.byProject": "By project",
    "usage.byProviderModel": "By provider & model",
    "usage.tokenActivity": "Token activity",
    "usage.tokenTrend": "Token trend",
    "usage.hoverHint": "Hover a day to see its usage details.",
    "usage.topProject": "Top project",
    "usage.topModel": "Top model",
    "usage.project": "Project",
    "usage.lastUsed": "Last used",
    "usage.projectUsage": "Project usage",
    "usage.projectHint": "Select a project to expand its model usage.",
    "usage.providerModel": "Provider / model",
    "usage.providerModelUsage": "Provider & model usage",
    "usage.providerHint": "Select a provider to expand its model usage.",
    "usage.empty": "No recorded usage exists for this period.",
    "usage.loadFailed": "Usage statistics could not be loaded. Try refreshing.",
    "plan.taskList": "Plan tasks",
    "plan.taskProgress": "Progress {completed}/{total}",
    "plan.taskCompleted": "Completed",
    "plan.taskRunning": "Running",
    "plan.taskPending": "Pending",
    "plan.toggleTask": "{status}: {task}",
    "appUpdate.releaseNotes": "Eureka v{version} is available. View release notes",
    ...
    "sidebar.extensionsCenter": "Extension Center",
    "extensions.description": "Manage skills and plugins",
    "extensions.skillsDescription": "View, enable, or install agent skills",
    "extensions.pluginsDescription": "Manage installed extension plugins",
    "extensions.organization": "Organization extensions",
    "extensions.official": "Official extensions",
    "extensions.market": "Marketplace extensions",
    "extensions.skills": "Skills",
    "extensions.mcp": "MCP",
    "extensions.plugins": "Plugins",
    "extensions.organizationSkills": "Organization skills",
    "extensions.organizationMcp": "MCP tools",
    "extensions.officialSkills": "Skills",
    "extensions.officialPlugins": "Plugins",
    "extensions.organizationSkillsDescription": "Configure and distribute agent skills for your organization",
    "extensions.organizationMcpDescription": "Connect and manage MCP tools for your organization",
    "extensions.organizationSkillsEmpty": "No organization skills are configured yet. Organization-provided skills will be managed here.",
    "extensions.organizationMcpEmpty": "No MCP tools are configured yet. Organization-provided tools will be managed here.",
    "extensions.marketLoading": "Loading organization extensions…",
    "extensions.marketUnauthenticated": "Sign in to Haze to view organization extensions.",
    "extensions.marketForbidden": "You do not have permission to access organization extensions. Request marketplace access in Haze.",
    "extensions.marketLoadFailed": "Organization extensions could not be loaded. Please try again.",
    "extensions.marketNoDescription": "No description",
    "extensions.marketUnknownAuthor": "Unknown author",
    "extensions.viewDetails": "View details",
    "extensions.install": "Install",
    "extensions.reload": "Reload",
    "extensions.allCapabilities": "All capabilities",
    "extensions.favorites": "Favorites",
    "extensions.frequent": "Frequently used",
    "extensions.businessCategories": "Business categories",
    "extensions.search": "Search capabilities, tags, authors, or departments…",
    "extensions.installed": "Installed",
    "extensions.globalInstall": "Global install",
    "extensions.projectInstall": "Project install",
    ...
    "extensions.marketUnavailable": "Marketplace information unavailable",
    "extensions.installedVersion": "Installed v{version}",
    "extensions.installedEmpty": "No {type} installed for this {scope} scope.",
    "extensions.installing": "Installing…",
    "extensions.installedSuccess": "Installed",
    "extensions.installDialogTitle": "Install {name}",
    "extensions.configureDialogTitle": "Configure {name}",
    "extensions.installScope": "Installation scope",
    "extensions.project": "Project",
    "extensions.global": "Global",
    "extensions.projectInstallNote": "Install in the current project only.",
    "extensions.globalInstallNote": "Install for all projects, available everywhere.",
    "extensions.alreadyInstalled": "Installed",
    "extensions.scopeAlreadyInstalled": "Already installed in this scope",
    "extensions.projectUntrusted": "The current project is not trusted, so project capabilities cannot be installed.",
    "extensions.lifecycle": "Lifecycle",
    "extensions.lifecycle.lazy": "Connect only when a Server tool is first called, saving resources.",
    "extensions.lifecycle.eager": "Connect when the session starts or reloads, reducing first-call wait time.",
    "extensions.lifecycle.keepAlive": "Keep the connection online when possible, suitable for frequently used Servers.",
    "extensions.idleTimeout": "Idle disconnect (minutes)",
    "extensions.idleTimeoutHint": "1–1440 minutes.",
    "extensions.invalidIdleTimeout": "Idle disconnect time must be between 1 and 1440 minutes.",
    "extensions.cancel": "Cancel",
    "extensions.confirmInstall": "Confirm install",
    "extensions.saveConfiguration": "Save configuration",
    "extensions.saving": "Saving…",
    "extensions.details": "Details",
    "extensions.quickStart": "Quick start",
    "extensions.documentation": "Documentation",
    "extensions.basicInformation": "Basic information",
    "extensions.version": "Version",
    "extensions.connectionType": "Connection type",
    "extensions.calls": "Calls",
    "extensions.callsCount": "{count} calls",
    "extensions.developer": "Developer",
    "extensions.department": "Department",
    "extensions.updatedAt": "Updated",
    "extensions.businessCategory": "Business category",
    "extensions.capabilityTags": "Capability tags",
    "extensions.capabilityDescription": "Capability description",
    "extensions.versionHistory": "Version history",
    "extensions.noTags": "No tags",
    "extensions.noDescription": "No description available",
    "extensions.contentLoading": "Loading…",
    "extensions.contentFailed": "Content failed to load.",
    "extensions.noContent": "Nothing to display.",
    "extensions.noMatches": "No matching organization extensions found.",
    "extensions.installedLoading": "Loading installed capabilities…",
    "extensions.installedLoadFailed": "Installed capabilities could not be loaded. Please try again.",
    "extensions.cardView": "Card view",
    "extensions.tableView": "Table view",
    "extensions.noVersionHistory": "No version history",
    "extensions.noVersionNotes": "No release notes",
    "extensions.favorite": "Favorite",
    "extensions.unfavorite": "Unfavorite",
    ...
    "sidebar.deleteSessionDescription": "This action cannot be undone.",
    "sidebar.deleteProject": "Delete project",
    "sidebar.deleteProjectConfirm": "This removes the project and its {count} sessions from Eureka. Project files are kept.",
    "sidebar.deleteProjectFailed": "Could not delete project: {error}",
    ...
    "chat.steerPlaceholder": "Type a message to steer the agent…",
    "chat.agentPlaceholder": "Agent is running…",
    "chat.messagePlaceholder": "Describe your idea…",
    "chat.steer": "Steer",
    "chat.followUp": "Follow-up",
    "chat.queueSend": "Queue message",
    "chat.immediateSteer": "Steer now",
    "chat.compactWhileRunning": "Context cannot be compacted while the agent is running.",
    "chat.pendingSend": "READY TO SEND",
    "chat.moveToInput": "Move to input",
    "chat.attachedImageCount": "{count} image(s)",
    "chat.referencedFiles": "Referenced files",
    "chat.openReference": "Open {path}",
    "chat.removeReference": "Remove {path}",
    "chat.send": "Send",
    "chat.attachImage": "Attach image",
    "chat.openAddMenu": "Add images or commands",
    "chat.addCommandMenu": "Add and command menu",
    "chat.searchAddCommands": "Search additions or commands…",
    "chat.noMatchingCommands": "No matching commands found",
    "chat.add": "Add",
    "chat.addImage": "Add image",
    "chat.addImageDescription": "Choose an image to attach to this message",
    ...
    "plan.download": "Download Markdown",
    "plan.copy": "Copy plan",
    "plan.submitReview": "Submit for review",
    "plan.openReview": "Plan review",
    "plan.view": "View plan",
    "plan.mode": "Plan mode",
    "plan.enableDescription": "Start read-only planning and review",
    "plan.answerRequired": "Please answer the current planning question first",
    "plan.cancelMode": "Cancel plan mode",
    "plan.stop": "Stop plan",
    "plan.reviewTitle": "Plan review",
    "plan.executionTitle": "Execute plan",
    "plan.viewTitle": "View plan",
    "plan.revisionStatus": "Revision {revision} · {status}",
    "plan.awaitingApproval": "Awaiting approval",
    "plan.executing": "Executing",
    "plan.history": "Plan history",
    "plan.closeReview": "Close plan review",
    "plan.addAnnotation": "Add a note to the selected section",
    "plan.annotationPlaceholder": "Describe what should change…",
    "plan.addNote": "Add note",
    "plan.noPlan": "No plan submitted.",
    "plan.generalNote": "General notes",
    "plan.generalNotePlaceholder": "Optional: share overall feedback for the Agent…",
    "plan.none": "None",
    "plan.progress": "Execution progress {completed}/{total}",
    "plan.abandon": "Abandon plan",
    "plan.returnForRevision": "Return for revision",
    "plan.approveExecute": "Approve and execute",
    "plan.abandonConfirmTitle": "Abandon this plan?",
    "plan.abandonConfirmDescription": "The plan will not run and will remain in history. Project files will not be changed.",
    "plan.continueEditing": "Continue editing",
    "plan.stopConfirmTitle": "Stop this plan execution?",
    "plan.stopConfirmDescription": "Completed changes and progress will be kept. Later messages will return to normal chat.",
    "plan.continueExecution": "Continue execution",
    "plan.question": "Planning question",
    "plan.customAnswer": "Custom answer",
    "plan.customAnswerPrefix": "Custom answer: {answer}",
    "plan.answerPlaceholder": "Enter your answer…",
    "plan.submitAnswer": "Submit",
    "plan.questionSkipped": "Skipped",
    "plan.previousQuestion": "Previous question",
    "plan.nextQuestion": "Next question",
    "plan.skipQuestion": "Skip",
    "plan.continueQuestion": "Continue",
    "plan.submitAnswers": "Submit answers",
    "i18n.cancel": "Cancel",
    "i18n.save": "Save",
    "i18n.saving": "Saving…",
    "i18n.saved": "Saved",
