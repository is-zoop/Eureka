...
test("remembers and clears the last selected project independently", () => {
  const storage = createStorage();
  setLastSelectedProject("E:/projects/one", storage);
  assert.equal(getLastSelectedProject(storage), "E:/projects/one");
  clearLastSelectedProject("E:/projects/two", storage);
  assert.equal(getLastSelectedProject(storage), "E:/projects/one");
  clearLastSelectedProject("E:/projects/one", storage);
