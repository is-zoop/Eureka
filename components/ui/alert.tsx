...
function AlertTitle({ className, ...props }: ComponentProps<"div">) { return <div data-slot="alert-title" className={cn("col-start-2 pr-7 font-semibold leading-5", className)} {...props} />; }
